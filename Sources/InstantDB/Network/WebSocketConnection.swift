...
public final class WebSocketConnection: NSObject {
  ...
  private func handleError(_ error: InstantError) {
    ...
    if error.isSSLTrustFailure {
      print("")
      print("[InstantDB] ════════════════════════════════════════════════════════════════")
      print("[InstantDB] ⚠️  SSL/TLS TRUST FAILURE - Cannot Connect to InstantDB")
      print("[InstantDB] ════════════════════════════════════════════════════════════════")
      print("[InstantDB]")
      print("[InstantDB] WHAT HAPPENED:")
      print("[InstantDB]   InstantDB requires a secure WebSocket connection to")
      print("[InstantDB]   api.instantdb.com for real-time data synchronization.")
      print("[InstantDB]   Your device rejected the server's SSL certificate.")
      print("[InstantDB]")
      print("[InstantDB] WHY THIS HAPPENS:")
      print("[InstantDB]   This is commonly caused by corporate security software that")
      print("[InstantDB]   intercepts HTTPS traffic to inspect it (SSL inspection/MITM):")
      print("[InstantDB]   • Zscaler")
      print("[InstantDB]   • Netskope")
      print("[InstantDB]   • Cisco AnyConnect / Umbrella")
      print("[InstantDB]   • Other corporate VPN/proxy solutions")
      print("[InstantDB]")
      print("[InstantDB] HOW TO FIX:")
      print("[InstantDB]   Option 1: Temporarily disable your VPN/proxy software")
      print("[InstantDB]   Option 2: Add your VPN's root certificate to the device trust store")
      print("[InstantDB]   Option 3: Ask IT to whitelist api.instantdb.com")
      print("[InstantDB]")
      print("[InstantDB] FOR iOS SIMULATOR:")
      print("[InstantDB]   1. Export your VPN's root certificate (e.g., 'Zscaler Root CA')")
      print("[InstantDB]   2. Drag the .cer/.pem file onto the simulator window")
      print("[InstantDB]   3. Go to Settings > General > VPN & Device Management")
      print("[InstantDB]   4. Tap the certificate profile and install it")
      print("[InstantDB]   5. Go to Settings > General > About > Certificate Trust Settings")
      print("[InstantDB]   6. Enable full trust for the root certificate")
      print("[InstantDB]")
      print("[InstantDB] InstantDB will automatically retry the connection...")
      print("[InstantDB] ════════════════════════════════════════════════════════════════")
      print("")
    }
